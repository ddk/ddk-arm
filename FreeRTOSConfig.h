...
//#define configCPU_CLOCK_HZ            ( ( unsigned long )    96000000UL )
...
#define configTIM0_INTERRUPT_PRIORITY     5
#define configTIM1_INTERRUPT_PRIORITY     6
#define configUSART_INTERRUPT_PRIORITY      8
